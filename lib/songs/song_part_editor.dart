...
import 'core_own_song/errors.dart';
...
class SongPartEditor extends StatefulWidget{
  ...
  final Widget Function(BuildContext, SongPartEditorState) topBuilder;
  final Widget Function(BuildContext, SongPartEditorState) bottomBuilder;

  final double elevation;

  const SongPartEditor(
      this.songPart,
