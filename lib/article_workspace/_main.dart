...
class ArticleWorkspacePage extends StatefulWidget{

  @override
  State<StatefulWidget> createState() => ArticleWorkspacePageState();

}

class ArticleWorkspacePageState extends State<ArticleWorkspacePage>{
