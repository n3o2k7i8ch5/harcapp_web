...
class WebModelSession extends InferenceModelSession {
  ...
  // PATCH (harcapp): see InferenceModelSession.clearQueryChunks. Lets a caller
  // reuse one session for many independent one-shot prompts without
  // accumulating previous turns (getResponse intentionally does NOT clear on
  // success, for InferenceChat).
  @override
